  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <h2 className="section-title">AI 调试</h2>
        <p className="text-sm text-slate-600">
          请设置 AI 昵称、头像、参数与提示词，以匹配你的招聘偏好。
        </p>
      </div>

      <section className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-slate-200 bg-white p-4">
          <h3 className="text-sm font-semibold text-slate-700">AI 昵称</h3>
          <label className="mt-4 block space-y-2">
            ...
            <input
              ...
              placeholder="例如：SynthRecruiter"
            />
          </label>
        </div>

        <div className="rounded-2xl border border-slate-200 bg-white p-4">
          <h3 className="text-sm font-semibold text-slate-700">AI 参数（0-100）</h3>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4">
          <h3 className="text-sm font-semibold text-slate-700">AI 头像</h3>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4">
          <h3 className="text-sm font-semibold text-slate-700">AI 提示词</h3>
          <label className="mt-4 block space-y-2">
            ...
            <textarea
              ...
              onChange={(event) => updateAIConfig({ prompt: event.target.value })}
